...
function Envshell() {
  return (
	<div id="envshell">
		<link rel="stylesheet" href="/src/Envshell.css" />
		<div id="hero">
			<div id="hero-gradient">
				...
				<div id="hero-content">
					<h1 id="hero-title">envShell</h1>
					<p id="hero-subtitle">Simplicity, Aesthetics, Functionality</p>
				</div>
			</div>
		</div>
		<div id="what">
			<div id="what-content">
				<div id="what-description">
		...
		<div class="feature-container">
			<div class="feature">
				...
				<div class="feature-description"><img src="https://raw.githubusercontent.com/E3nviction/envshell/refs/heads/master/assets/screenshot-new-cc.png" alt="Screenshot of the new Control Center" class="screenshot" /></div>
			</div>
			<div class="feature">
				<div class="feature-description"><img src="https://raw.githubusercontent.com/E3nviction/envshell/refs/heads/master/assets/screenshot-bluetooth.png" alt="Screenshot of the Bluetooth window" class="screenshot" /></div>
				<div class="feature-title">
			...
			<div class="feature">
				...
				<div class="feature-description">
					...
					<p class="tag warning" title="Features, promised in the description might not be implemented, or won't work correctly">Still in development</p>
				</div>
			</div>
			<div class="feature">
				<div class="feature-description">
			...
			<div class="feature">
				...
				<div class="feature-description"><img src="https://raw.githubusercontent.com/E3nviction/envshell/refs/heads/master/assets/screenshot-systray.png" alt="Screenshot of the System Tray" class="screenshot" /></div>
			</div>
			<div class="feature top-feature">
				...
				<div class="feature-description big">
		...
		<div class="screenshot-wrapper">
			...
			<div class="screenshot-container">
				<div class="screenshot-container-image">
